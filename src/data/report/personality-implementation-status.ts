...
export const PERSONALITY_IMPLEMENTATION_MANIFEST:
  ...
  Object.freeze([
    ...
    entry("INFJ", ["domain_complete", "validated"]),
    entry("INFP", ["domain_complete", "validated"]),
    entry("ENFJ", ["domain_complete", "validated"]),
    entry("ENFP", ["domain_complete", "validated"]),
    entry("ISTJ", ["domain_complete", "validated"]),
    entry("ISFJ", [
      "domain_complete",
      "validated",
      "frontend_enabled",
