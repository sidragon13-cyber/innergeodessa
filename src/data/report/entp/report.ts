...
> = {
  ...
  "core-personality-pattern": [
    ...
    block(
      ...
      "A practical strength of this pattern is the ability to make structures feel personally responsive. An ENTP may translate concern into a prepared document, a timely reminder, a comfortable environment, or a carefully completed handover. These actions can increase safety and belonging because other people experience care through consistent details rather than through intention alone.",
    ),
    block(
      "entp-core-risk",
      "risk",
  ...
  "information-processing": [
    ...
    block(
      ...
      "Rather than beginning with an abstract possibility, an ENTP may build understanding from remembered examples and observable evidence. A new situation is compared with prior cases to identify continuity and difference. This approach can reveal small risk signals and implementation details, especially when the person has enough experience and when memory is checked against current facts.",
    ),
    block(
  ...
  "decision-making": [
    block(
      ...
      "ENTP decisions may weigh effects on people, existing obligations, practical consequences, and continuity. A good decision often feels both considerate and workable: it protects important relationships while preserving the routines or resources that make follow-through possible. This orientation can improve implementation because the decision includes people who will live with its consequences.",
    ),
    block(
  ...
  "teamwork-and-leadership": [
    ...
    block(
      ...
      "Informal responsibility can expand because doing the task personally feels faster or safer than explaining it. Over time, colleagues may underestimate the work, fail to build capability, or assume the ENTP prefers to own it. The result can be overload paired with frustration that nobody volunteers for responsibilities they cannot see.",
    ),
    block(
  ...
  "career-environment": [
    block(
      ...
      "summary",
      "Career Environments",
      "An ENTP may thrive in structured but humane environments where responsibilities are defined, contribution is practical, and relationships develop through continuity. Useful work is easier to sustain when service quality matters, expectations are credible, and careful follow-through is recognised rather than treated as an unlimited resource.",
    ),
    block(
  ...
  "relationship-dynamics": [
    block(
      ...
      "ENTPs may build closeness through loyalty, remembered details, practical care, and efforts that create emotional safety. They often notice what makes another person comfortable and may express commitment by being available during ordinary demands. These behaviours can deepen trust when care moves in both directions and when needs are spoken rather than assumed.",
    ),
    block(
  ...
  "stress-and-recovery": [
    block(
      ...
      "summary",
      "Stress Signals",
      "Stress may develop quietly when duties accumulate faster than they are questioned or shared. An ENTP can continue meeting visible obligations while internal flexibility and energy decline. Early recognition matters because the outward appearance of reliability may delay support until overload is already affecting mood, judgement, or health.",
    ),
    block(
  ...
  "growth-roadmap": [
    block(
      ...
      "summary",
      "Boundary Practice",
      "Growth for an ENTP does not require becoming less caring. It involves making care more deliberate, visible, and sustainable. Key themes include direct needs, manageable disagreement, exploration of alternatives, prioritisation, delegation, and a broader sense of identity than usefulness alone.",
      [
        {
          id: "entp-combination-boundary-risk",
          source: "combination",
          dimensions: ["TF", "JP"],
        },
      ],
