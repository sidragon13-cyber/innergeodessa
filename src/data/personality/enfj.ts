...
export const enfjProfile: PersonalityProfile = {
  ...
  premiumPreview: {
    ...
    sections: [
      ...
      { id: "career-environment", title: { en: "Career Environment" }, description: { en: "Settings that reward purpose, interaction, and organised impact." }, access: "premium" },
      { id: "stress-patterns", title: { en: "Stress Patterns" }, description: { en: "Recognising approval pressure, overload, and emotional fatigue." }, access: "premium" },
